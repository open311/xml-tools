...
<head>
	...
	<title>XML to JSON using the Parker Convention</title>
...
<h3>XML to JSON Conversion using the Parker Convention</h3>
<ul>
	<li><a href="http://code.google.com/p/xml2json-xslt/wiki/TransformingRules">View documentation on the Parker Convention</a></li>
	<li>View the source of this conversion script: <a href="xml2json_parker_php.txt">PHP</a> and <a href="xml2json_parker.xsl">XSL transformation rules</a></li>
</ul>
